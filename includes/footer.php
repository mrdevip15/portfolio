    ...
    <footer class="border-t border-gray-100 py-16 text-center text-sm text-brand-gray">
      <div class="max-w-6xl mx-auto px-6 flex flex-col justify-between items-center gap-8 md:flex-row">
        ...
        <div class="flex space-x-8">
            <a class="inline-flex items-center gap-2 transition hover:text-brand-black" href="https://github.com/mrdevip15">
            ...
            <a class="inline-flex items-center gap-2 transition hover:text-brand-black" href="<?php echo $base; ?>blog/">
