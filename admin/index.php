...
<main class="max-w-6xl mx-auto px-6 py-24">
    <div class="flex justify-between items-center mb-12">
        ...
        <a href="../billing/index?logout=1" class="text-sm font-medium text-red-600 hover:text-red-800">Sign Out</a>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-12">
        ...
        <div class="bg-brand-light p-8 rounded-3xl border border-gray-100">
            <div class="text-xs font-bold text-brand-gray uppercase mb-2">Stories</div>
            <div class="text-3xl font-semibold"><?php echo $testimonial_count; ?></div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <section>
            ...
            <div class="space-y-4">
                <a href="posts" class="block p-6 bg-white border border-gray-100 rounded-2xl hover:shadow-lg transition">
                ...
                <a href="../billing/index" class="block p-6 bg-white border border-gray-100 rounded-2xl hover:shadow-lg transition">
                ...
                <a href="projects" class="block p-6 bg-white border border-gray-100 rounded-2xl hover:shadow-lg transition">
                ...
                <a href="testimonials" class="block p-6 bg-white border border-gray-100 rounded-2xl hover:shadow-lg transition">
                    <div class="font-semibold text-brand-black">Client Stories</div>
                    <div class="text-sm text-brand-gray">Manage testimonials and client feedback.</div>
                </a>
                <a href="settings" class="block p-6 bg-white border border-gray-100 rounded-2xl hover:shadow-lg transition">
